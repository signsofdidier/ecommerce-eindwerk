                        ...
                        <div class="new-item" data-aos="fade-up" data-aos-duration="300">
                                <div class="product-card">
                                    <div class="product-card-img">
                                        <a class="product-hover-zoom" href="{{ tenant_url('products') }}/{{ $featured->slug }}">
                                            <img class="primary-img" src="{{ url('storage', $featured->images[0]) }}"
                                                 alt="product-img">
                                        </a>

                                        <div class="product-card-action product-card-action-2">
                                            <a href="{{ tenant_url('products') }}/{{ $featured->slug }}" class="quickview-btn btn-primary">VIEW</a>
                                    ...
                                    <div class="product-card-details text-center">
                                        <h3 class="product-card-title"><a href="{{ tenant_url('products') }}/{{ $featured->slug }}">{{ $featured->name }}</a>
                                        </h3>
