                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4 text-md-end">
                                        <a href="{{ route('my-orders', ['company' => \App\Services\TenantService::slug(), 'order_id' => $order->id]) }}" class="btn btn-sm btn-outline-secondary me-2">Details</a>
                                        <a href="{{ route('my-orders.invoice', ['company' => \App\Services\TenantService::slug(), 'order_id' => $order->id]) }}" class="btn btn-sm btn-outline-secondary">Download PDF</a>
                                    </div>
                                </div>
                            </div>
                        </div>
