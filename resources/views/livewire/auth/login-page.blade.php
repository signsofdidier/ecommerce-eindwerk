                ...
                <div class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-4">
                    <div class="text-center mb-5">
                        ...
                        <p class="text-muted">
                            ...
                            <a href="{{ url('/' . currentCompany()->slug . '/register') }}" class="text-decoration-none fw-semibold" style="color: #2c5aa0;">Sign up here</a>
                        </p>
                    </div>
                    ...
                    <form wire:submit.prevent="save">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-4">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <a href="{{ url('/' . currentCompany()->slug . '/forgot') }}" class="text-decoration-none fw-semibold" style="color: #2c5aa0;">Forgot password?</a>
                                </div>
                                <div class="position-relative">
                                    <input type="password"
                                           id="password"
                        ...
                        <a href="{{ url('/' . currentCompany()->slug . '/register') }}"
