            ...
            <div class="cart-content-area d-flex justify-content-between flex-column">
                    ...
                    @forelse($cart_items as $item)
                        <div class="minicart-item d-flex">
                            ...
                            <div class="product-info">
                                <h2 class="product-title"><a href="{{ tenant_url('products/' . $item['slug']) }}">{{ $item['name'] }}</a></h2>
                ...
                <div class="minicart-footer">
                    ...
                    <div class="minicart-btn-area d-flex align-items-center justify-content-between">
                        <a href="{{ tenant_url('cart') }}" class="minicart-btn btn-secondary">View Cart</a>
                        <a href="{{ tenant_url('checkout') }}" class="minicart-btn btn-primary">Checkout</a>
                    </div>
                </div>
            </div>
