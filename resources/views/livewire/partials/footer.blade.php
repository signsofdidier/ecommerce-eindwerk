        ...
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
            ...
            <div class="col-span-1">
                ...
                <div class="mt-3 grid space-y-3">
                    ...
                    <p><a class="inline-flex gap-x-2 text-gray-400 hover:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="{{ tenant_route('products') }}">All Products</a></p>
                    <p><a class="inline-flex gap-x-2 text-gray-400 hover:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="{{ tenant_route('products') }}">Featured Products</a></p>
                </div>
            </div>
            <!-- End Col -->
